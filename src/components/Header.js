        ...
        <>
            <main>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-6">
                            <img className="logo d-sm-none d-none d-md-block d-lg-block" src="https://res.cloudinary.com/dkpbs7ll6/image/upload/v1624344040/twwrmxzxayiowu9bisgl.png" alt="logo" />
                        </div>
                ...
                <nav className="pt-2 border-bottom navbar navbar-expand-lg navbar-light nav-responsive">
                    <div className="container">
                        <a className="navbar-brand" href="/">
                            <img className="logo d-sm-block d-block d-md-none d-lg-none" src="https://res.cloudinary.com/dkpbs7ll6/image/upload/v1624344040/twwrmxzxayiowu9bisgl.png" alt="logo" />
                        </a>
